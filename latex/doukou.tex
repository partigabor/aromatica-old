...
\begin{figure}[!h]
    \centering
    \includegraphics[width=0.33\textwidth]{imgs/cardamom_seed_pods.png}
...
In Europe, the Middle East, India, and many other parts of the world, \textit{cardamom} typically refers to the seed pods of \textit{Elettaria cardamomum} (L.) Maton, which is an aromatic flowering plant in the ginger family (\textit{Zingiberaceae}), and can be seen on Figure \ref{fig:cardamom}. It is native to India's Western Ghats, the mountain range streching above the Malabar coast. This is the same region where black pepper hails from, and in an Indian context they are often called ``the king and queen of spices'' -- cardamom being the queen \parencite{nair_2020_geographya}. 

It is a well-known culinary spice with a long history, also used in the infusion of beverages and perfumery (e.g., Indian cuisine, Arabian coffee, etc.). Cardamom has been in use in India since the Vedic period and was traded to and through Mesopotamia since the Bronze Age \parencites{parry_1969_spices}{ravindran_2002_cardamom}. 

In Europe, it was known since antiquity and was used as medicine -- Greek historians and physicians, such as Theophrastus, Dioscorides, Galen, and Pliny have documented its healing properties, sometimes even correctly identifying India as the place of origin \parencite{ravindran_2002_cardamom, anderson_2023_history}.
