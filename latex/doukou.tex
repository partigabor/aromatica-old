...
\title{Cardamoms in China, and a new etymology for \textit{dòukòu} `cardamom; nutmeg'}
...
\setlength{\tabcolsep}{4pt} % Change table padding
...
\begin{figure}[!ht]
	\vspace{-2ex}
	\centering
	\subfloat{\includegraphics[width=0.3\linewidth]{imgs/green-cardamom.jpg}}
	\hfill
	\subfloat{\includegraphics[width=0.3\linewidth]{imgs/black_cardamom.jpg}}
	\hfill
	\subfloat{\includegraphics[width=0.3\linewidth]{imgs/white_cardamom.jpg}}
	\caption{Green cardamoms (\textit{Elettaria cardamomum} from India) (left), black cardamoms (middle), and white cardamoms(). Credit: Aromatiques.}
	\label{fig:cardamom_imgs}
\end{figure}

% Photo by <a href="https://unsplash.com/@iranskids?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Mohammad Amiri</a> on <a href="https://unsplash.com/photos/bunch-of-green-peas-sVZKd94vFHo?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>
  
% https://nai4trade.com/spices/
% https://keralaspecial.in/product/black-cardamom/


% Image by <a href="https://pixabay.com/users/anupam2023-38370105/?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=8140138">Anupam Roy</a> from <a href="https://pixabay.com//?utm_source=link-attribution&utm_medium=referral&utm_campaign=image&utm_content=8140138">Pixabay</a>
...
% diverse range of dialectal variations and linguistic nuances, which are beyond the scope of this discussion 

% with many-many dialectal variations that are out of scope for now
...
\begin{quote}
    ...
    \textbf{White cardamom}, comes from the country of \textcolor{accent}{Kakula}, called \textcolor{accent}{/tɑ-kuət̚/}. [\dots]
