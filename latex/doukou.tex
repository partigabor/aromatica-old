...
\addbibresource{parti.bib} %
% \addbibresource{joo.bib} %
...
% Title, author, date
\title{Cardamoms in China, and the Quest for the Etymology of \tc{豆蔻} \textit{dòukòu} `cardamom; nutmeg'}
...
% Scholars that looked into kakola-type words in Semitic languages ignored the instances in South, East, and Southeast Asia, 

% Linguists have to be versed in the botany and history of these products as well to make meaningful conclusions.
...
% Takola is in the center of the biodiversity hotspot where these plants are native.
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=\textwidth]{imgs/map.png}
...
% Reasons:
% 1 The word appears in Chinese historical records with its origin and pronunciation
% 2 The word emerges with the arrival of the foreign economic products it denotes
% 3 The word is denoted as a loanword by other linguists connecting it to Takola
% 4 The word seems to fit into a group of takkola-type Wanderwörter in the region
...
% Explain phono-semantic matching; and elaborate more what the hell happened

% Phono-semantic matching: (where the word‘s non-native quality is hidden by replacing it with phonetically and semantically similar words from the adopting language) 可口可乐 Coca-Cola, ‘happy and entertaining’, 万维网 wàn wéi wǎng ‘myriad dimensional net’ = www. 
